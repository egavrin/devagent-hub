...
export function parseProjectBrief(markdown: string): ProjectBrief {
  ...
  type Section = "none" | "description" | "goals" | "constraints" | "techstack" | "features" | "milestones";
    ...
    if (/^### /.test(trimmed)) {
      if (currentSection === "features") {
        ...
        const priority = priorityMatch
          ? (priorityMatch[0].replace(/[()]/g, "") as Feature["priority"])
          : "should-have";
...
export function loadProjectBrief(filePath: string): ProjectBrief {
