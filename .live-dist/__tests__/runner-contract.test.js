...
import { buildLaunchArgs, InvalidLaunchConfigError, } from "../runner/args-builder.js";
...
describe("runner contract: phase validation", () => {
    it("never emits gate as a phase", () => {
        expect(() => buildLaunchArgs({ ...baseParams, phase: "gate" }, {})).toThrow(InvalidLaunchConfigError);
    });
