...
describe("uiReducer", () => {
    ...
    describe("dialogs", () => {
        it("OPEN_DIALOG new-run resets form", () => {
            const withData = {
                ...initialUIState,
                newRunForm: { sourceType: "pr", sourceId: "42", mode: "watch", profile: "fast", runner: "claude", model: "sonnet", gateStrictness: "normal", priority: "normal" },
            };
        ...
        it("BACK closes dialog before navigating", () => {
            const inRunWithDialog = dispatch(initialUIState, { type: "OPEN_RUN", runId: "r1" }, { type: "OPEN_DIALOG", dialog: "rework" });
    ...
    describe("new run form", () => {
        ...
        it("form fields are independent", () => {
            const s = dispatch(initialUIState, { type: "SET_NEW_RUN_SOURCE_TYPE", sourceType: "pr" }, { type: "SET_NEW_RUN_SOURCE_ID", value: "99" }, { type: "SET_NEW_RUN_MODE", mode: "watch" });
        ...
        it("OPEN_DIALOG new-run resets runner and model", () => {
            const withData = {
                ...initialUIState,
                newRunForm: { sourceType: "pr", sourceId: "42", mode: "watch", profile: "fast", runner: "claude", model: "opus", gateStrictness: "strict", priority: "high" },
            };
            const s = dispatch(withData, { type: "OPEN_DIALOG", dialog: "new-run" });
    ...
    describe("log mode", () => {
        ...
        it("SET_LOG_MODE switches back to structured", () => {
            const s = dispatch(initialUIState, { type: "SET_LOG_MODE", mode: "raw" }, { type: "SET_LOG_MODE", mode: "structured" });
    ...
    describe("complex flows", () => {
        ...
        it("new run dialog flow", () => {
            ...
            expect(s.dialog).toBe("new-run");
            // Configure
            s = dispatch(s, { type: "SET_NEW_RUN_SOURCE_TYPE", sourceType: "pr" }, { type: "SET_NEW_RUN_SOURCE_ID", value: "42" }, { type: "SET_NEW_RUN_MODE", mode: "watch" });
        ...
        it("state does not leak between runs", () => {
            ...
            s = dispatch(s, { type: "SET_LOG_MODE", mode: "raw" }, { type: "TOGGLE_ARTIFACT_DIFF" }, { type: "SET_FOCUSED_PANE", pane: "logs" });
            // Open different run
    ...
    describe("gate strictness and priority", () => {
        ...
        it("OPEN_DIALOG new-run resets gate strictness and priority", () => {
            const withData = {
                ...initialUIState,
                newRunForm: { ...initialUIState.newRunForm, gateStrictness: "strict", priority: "high" },
            };
            const s = dispatch(withData, { type: "OPEN_DIALOG", dialog: "new-run" });
    ...
    describe("unknown action", () => {
        it("returns state unchanged for unknown action type", () => {
            const s = uiReducer(initialUIState, { type: "NONEXISTENT" });
